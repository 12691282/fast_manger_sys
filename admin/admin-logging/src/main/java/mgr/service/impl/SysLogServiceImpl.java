...
import mgr.domain.SysLog;
import mgr.mapper.SysLogMapper;
import mgr.service.SysLogService;
import mgr.domain.dto.SysLogQueryCriteria;
import mgr.utils.*;
...
public class SysLogServiceImpl extends ServiceImpl<SysLogMapper, SysLog> implements SysLogService {
    ...
    public void save(String username, String browser, String ip, ProceedingJoinPoint joinPoint, SysLog sysLog) {
        ...
        mgr.annotation.Log aopLog = method.getAnnotation(mgr.annotation.Log.class);
