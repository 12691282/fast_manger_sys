 ...
 */
package fangsl.aspect;

import lombok.extern.slf4j.Slf4j;
import fangsl.domain.SysLog;
import fangsl.service.SysLogService;
import fangsl.utils.RequestHolder;
...
public class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(fangsl.annotation.Log)")
